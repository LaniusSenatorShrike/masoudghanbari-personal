    ...
    <section className="min-h-screen py-32 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-start mb-16">
          ...
          <Button className="gap-2 bg-[var(--color-accent)] hover:bg-[var(--color-accent-dark)] text-gray-900">
        ...
        <div className="mb-20">
          ...
          <div className="space-y-12">
            {content.experience.map((job) => (
              ...
              >
                <div className="mb-4">
                  <Badge variant="outline" className="mb-3 text-gray-300">
                    {job.period}
                  </Badge>
            ...
            {content.certifications.map((cert) => (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <Badge variant="outline" className="text-gray-300">{cert.year}</Badge>
                </div>
              </div>
            ))}
          </div>
